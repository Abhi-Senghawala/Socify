...
import { Heart, Sparkles, Menu, Search, User, LogOut, X } from "lucide-react";
...
const MobileTopbar = () => {
  ...
  return (
    <div className="md:hidden fixed top-0 left-0 right-0 z-50">
      ...
      {/* Slide-out menu */}
      {showMenu && (
        <div className="absolute top-14 left-0 right-0 bg-gray-900/95 backdrop-blur-xl border-b border-white/10 shadow-2xl animate-slideDown">
