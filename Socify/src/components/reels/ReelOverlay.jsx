...
const ReelOverlay = ({ reel, isFollowing, onFollow, onMoreClick }) => {
  ...
  return (
    <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-black/80 via-black/40 to-transparent">
      <div className="p-3 sm:p-4 pt-safe-top">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
                ...
                <span className="text-[10px] sm:text-xs text-gray-300 whitespace-nowrap">
                  {formatFollowers(reel.user.followers)} followers
                </span>
              </div>
        ...
        {isMobile && showFullDescription && (
          <div className="mt-2 h-0.5 w-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full animate-pulse mx-auto" />
        )}
      </div>
    </div>
  );
